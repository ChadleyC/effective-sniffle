...
const Dashboard: React.FC = () => {
  ...
  const recentProjects: Project[] = [
    { 
      id: 1, 
      name: 'Global Site Redesign', 
      description: 'Updating the core brand identity across all digital platforms.',
      ownerId: 1,
    ...
    { 
      ...
      description: 'Transitioning legacy payment gateways to the new API architecture.',
      ownerId: 1,
      createdAt: new Date().toISOString()
    },
  ];
